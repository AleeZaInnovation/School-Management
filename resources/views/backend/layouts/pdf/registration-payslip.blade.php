...
<table width="100%">
	<tbody>
		<tr>
			<td width="100%" style="text-align: center; color: black;  padding: 5px 0px; font-size: 15px;"><h4><strong> Registraion Pay Slip  </strong></h4></td>
		</tr>
	</tbody>
</table>
@php
    $regfee=
    App\Model\FeeAmount::where('fee_category_id','1')->where('class_id',$details->class_id)->first();
...
<table width="100%" border="1" style="text-align: center;">
    ...
    <tr>
    	<td style="text-align: left;"> Registraion Fee </td>
    ...
    <tr>
    	<td style="text-align: left;"> Fee (This student) </td>
