        ...
        <div class="row">
          ...
          <section class="col-md-12">
            ...
            <div class="card">
              ...
              <div class="card-body">
                <form method="post" action="{{(@$edits)?route('setups.assign.subject.update' ,  $edits[0]->fee_category_id):route('setups.assign.subject.store')}}" id="myForm" enctype="multipart/form-data">
                  @csrf
                  <div class="add_item">
                    <div class="form-row">
