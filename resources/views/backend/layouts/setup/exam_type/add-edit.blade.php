          ...
          <section class="col-md-12">
            ...
            <div class="card">
              <div class="card-header">
                ...
                Add Exam Type
                @endif
                <a class="btn btn-success my-3 float-sm-right" href="{{route('setups.exam.type.view')}}"><i class="fa fa-list"></i> Exam Type List </a>
               </h3>
              </div><!-- /.card-header -->
              <div class="card-body">
                <div class="tab-content p-0">
                  <form method="post" action="{{(@$edits)?route('setups.exam.type.update' , $edits->id):route('setups.exam.type.store')}}" id="myForm" enctype="multipart/form-data">
                  @csrf
                  <div class="form-row">
