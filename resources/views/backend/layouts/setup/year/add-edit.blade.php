          ...
          <section class="col-md-12">
            ...
            <div class="card">
              <div class="card-header">
                ...
                Add Year
                @endif
                <a class="btn btn-success my-3 float-sm-right" href="{{route('setups.student.year.view')}}"><i class="fa fa-list"></i> Year List </a>
               </h3>
              </div><!-- /.card-header -->
              <div class="card-body">
                <div class="tab-content p-0">
                  <form method="post" action="{{(@$edits)?route('setups.student.year.update' , $edits->id):route('setups.student.year.store')}}" id="myForm" enctype="multipart/form-data">
                  @csrf
                  <div class="form-row">
