          ...
          <section class="col-md-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3> Employee List
                  <a class="btn btn-success my-3 float-sm-right" href="{{route('employee.reg.add')}}"><i class="fa fa-plus-circle"></i>Add Employee </a>
               </h3>
              </div><!-- /.card-header -->
              <div class="card-body">
                <div class="tab-content">
                  ...
                  <tbody>
                    ...
                    <tr class="{{$item->id}}">
                      ...
                      @endif 
                      <td>
                        <a title="Edit" class="btn btn-sm btn-success" href="{{ route('employee.reg.edit', $item->id) }}"><i class="fa fa-edit"></i></a>
