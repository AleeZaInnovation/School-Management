                ...
                <div class="tab-content p-0">
                  ...
                  <div class="form-row">
                    <div class="form-group col-md-4">
                          ...
                          <select id="role" name="role" id="role" class="form-control @error('role') Invalid @enderror"  value="{{ $edits->role }}">
                                <option value="">*Select Member Type*</option>
                                <option value="Admin" @if($edits->role == 'Admin')selected @endif>Admin</option>
                                <option value="Operator" @if($edits->role == 'Operator') selected @endif>Operator</option>
                          </select>
                          @error('role')
